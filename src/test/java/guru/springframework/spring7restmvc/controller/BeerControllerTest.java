...
class BeerControllerTest {
    ...
    void testPatchBeer() throws Exception {
        ...
        assertThat(beerArgumentCaptor.getValue().getBeerStyle()).isEqualTo(beerMap.get("beerStyle"));
    }
    ...
    void testCreateNewBeer() throws Exception {
        ...
        given(beerService.createBeer(any(Beer.class))).willReturn(beerServiceImpl.listBeers().getLast());
    ...
    void testListBeers() throws Exception {
        ...
        mockMvc.perform(get(BeerController.BEER_PATH)
                ...
                .andExpect(jsonPath("$[0].id", is(firstTestBeer.getId().toString())))
                .andExpect(jsonPath("$[0].beerName", is(firstTestBeer.getBeerName())));
    }
